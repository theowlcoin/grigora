...
"Copyright &copy; 2011-YYYY The Grigora developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Grigora", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Grigora</b> version", 0));
